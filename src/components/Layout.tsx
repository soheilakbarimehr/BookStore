...
const Layout = () => {
  // تنظیم حالت اولیه isDarkMode بر اساس localStorage
  ...
  // اعمال کلاس dark هنگام لود شدن کامپوننت
  useEffect(() => {
    if (isDarkMode) {
        ...
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            ...
            <div className="items-center hidden space-x-8 md:flex rtl:space-x-reverse">
              ...
              <button onClick={() => setIsAuthModalOpen(true)} className="px-4 py-2 text-white rounded-md bg-primary-600 hover:bg-primary-700">
                ورود / ثبت‌نام
              </button>
